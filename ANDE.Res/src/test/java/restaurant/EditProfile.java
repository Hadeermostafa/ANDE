...
public class EditProfile extends Base{
	...
	public void register() throws InterruptedException {
        ...
        **/  
		...
		restaurantname.sendKeys("RESTUARANT NAME 2");
		...
		transname.clear();
		transname.sendKeys("اسم المطعم 2");
		...
		String logoname = "Screenshot_1.jpg";
		...
		description.clear();
		description.sendKeys("description 2");
		...
		for (WebElement webElement : locationlist) {
			...
			if (webElement.getText().equals("Egypt")) {
				webElement.click();
			}
		}
		...
		for (WebElement webElement : currancylist) {
			...
			if (webElement.getText().equals("EGP")) {
				webElement.click();
			}
		}
