...
public class Tables extends Base {
   ...
   public void PrintTable() throws InterruptedException {
	   ...
	   Thread.sleep(200);
	   WebElement print = driver.findElement(By.xpath("/html/body/div[3]/div/div[1]/div[2]/div/div[1]/div/div[2]/form/button[2]"));
	   print.click();
   ...
   public void DeleteTable() throws InterruptedException {
	...
	Thread.sleep(400);
	WebElement delete = driver.findElement(By.xpath("/html/body/div[3]/div/div[1]/div[2]/div/div[1]/div/div[2]/form/button[1]"));
	delete.click();
